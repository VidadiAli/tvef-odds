...
const SF2Eight = () => {
    ...
    if (!localStorage.getItem('indexArrayOfSf2Eight')) indexArray = [];
    else {
        const localArrayFinal = localStorage.getItem('indexArrayOfSf2Eight').split(',')
    ...
    finalData && finalData.forEach((e) => {
        ...
        localStorage.setItem('indexArrayOfSf2Eight', indexArrayForLocal);
    });
    ...
    return (
        <>
            ...
            <SemiOdds finalData={finalData} listOfDown={listOfDown} listOfUp={listOfUp}
                waitClass={waitClass} leader1={leader1} leader2={leader2} leader3={leader3} edition={8} sf={2} />
        </>
    )
}

export default SF2Eight
