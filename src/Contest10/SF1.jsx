...
const SF1 = () => {
    ...
    const callData = async () => {
        ...
        const tempFinal = [...data.sf1]
        tempFinal.sort((a, b) => (a.puan1 + a.puan2) - (b.puan1 + b.puan2))
    ...
    if (localStorage.getItem('indexArrayOfSf1')) {
    ...
    localStorage.setItem('indexArrayOfSf1', indexArray)
