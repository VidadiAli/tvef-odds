...
const SF2Seven = () => {
    ...
    const callData = async () => {
        ...
        const data = (await axios.get(`${mainUrl7}sf2`)).data;
        setFinalData(data);
        setWaitClass('');
    ...
    if (!localStorage.getItem('indexArrayOfSf2Seven')) indexArray = [];
    else {
        const localArrayFinal = localStorage.getItem('indexArrayOfSf2Seven').split(',')
    ...
    finalData && finalData.forEach((e) => {
        ...
        localStorage.setItem('indexArrayOfSf2Seven', indexArrayForLocal);
    });
